 ...
 <div class="d-flex" id="wrapper">
  <!-- Sidebar -->
    <div class="bg-light border-right" id="sidebar-wrapper">
      <div class="sidebar-heading">List Materi</div>
      <div class="list-group list-group-flush">
        <?php foreach ($data->result_array() as $d) :?>
          <a href="<?= base_url($d['href_menu']);?>" class="list-group-item list-group-item-action bg-light"><?= $d['sub_menu']; ?></a>
        <?php endforeach; ?>
      </div>
    </div>
    <!-- /#sidebar-wrapper -->
